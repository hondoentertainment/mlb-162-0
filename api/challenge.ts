 ...
 * the per-code preview here; browsers bounce straight into the app, where the
 * `?c=` param starts the run.
 */
export default function handler(req: Request): Response {
  ...
  const title = `162-0 challenge ${code} — same spins, no skips`;
  const description = `Take on challenge ${code}. Everyone with this code drafts from identical spins. Can you build the better nine?`;
...
<html lang="en">
  <head>
    ...
    <meta property="og:site_name" content="162-0" />
  ...
  <body style="margin:0;background:#07140d;color:#f4efe4;font-family:system-ui,sans-serif">
