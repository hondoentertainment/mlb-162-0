...
Each spin lists every player from that franchise and decade — 1,000+ unique names across every club era. Only open eligible slots can be drafted; everyone else stays visible. Empty legal pools redraw automatically in Classic, Diamond IQ, Salary Cap, and One Franchise (not a skip). Daily and Challenge never grant a redraw.
